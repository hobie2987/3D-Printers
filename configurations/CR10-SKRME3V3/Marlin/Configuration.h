 ...
 * - CR10 frame + 300x300x400 Build Volume
 * - 24v Meanwell PSU
 * - 310x310 24v Heated Bed
 * - BTT SKR Mini E3 V3.0
 * - Reliabot 24v MOFSET for heated bed
 * - Ender 3 V2 Screen (DWIN)
 * - Sprite Extruder
 * - CRTouch
 * - T13 Thermistor (300 C)
 * - Dual Z Motors
 * - Orange Pi 3b running Octoprint: Communication through TFT pins
 * - Ender3V2 Professional Firmware - Config changes below
 *
 * Special Configuration Features (Enabled)
 ...
 * - DWIN_LCD_PROUI
 * - MPCTEMP (Model Predictive Temp Control)
 *
 * Manual Configuration Changes
 * - SERIAL_PORT 2 // (TFT Pins for Octoprint) [L123]
 * - NO_CONTROLLER_CUSTOM_WIRING_WARNING // Disable custom cable warning for E3V2 screen [L174]
 *
 * Applied through Configuration GCODE File
 * - Disable Filament Runout Sensor
 * - Disable Power-loss recovery
 * - 300x300 Bed Size
 * - Physical Maximum 310x310x350
 * - CR Touch Z-Probe Offset: X-31.80 Y-40.50 Z??
 * - Extruder ESteps: 424.90
 */
...
#define CUSTOM_MACHINE_NAME "CR10-SKRME3V3-BLTUBL-T13-MPC"
